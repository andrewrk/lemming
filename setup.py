...
PACKAGEDATA = {
    ...
    'package_dir': {'lemming': 'lemming',
                   },
    'packages': ['lemming',
                ],
    'scripts': ['scripts/lemming'],
}
...
_DATA_DIR = os.path.join('lemming', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'lemming': data_dirs}
